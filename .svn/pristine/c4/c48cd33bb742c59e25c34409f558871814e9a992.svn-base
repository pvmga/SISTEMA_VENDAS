<script type="text/javascript">
    $(function () {
        ...
        function preencherMascara() {
            ...
            $('#cpf-produtor').mask('000.000.000-00');
            ...
            $('.cpf').addClass('hidden');
            $('.rg').addClass('hidden');
            $('.cpf-produtor').addClass('hidden');
            $('.inscricao-produtor').addClass('hidden');
...
//                $('#modal-success').modal('hide');
        ...
        function alternarCampos() {
            ...
            } else if (tipoPessoa === 'R') {
                $('.cnpj').addClass('hidden');
                $('.inscricao').addClass('hidden');
                $('.cpf').addClass('hidden');
                $('.rg').addClass('hidden');
                $('.cpf-produtor').removeClass('hidden');
                $('.inscricao-produtor').removeClass('hidden');
            } else {
        ...
        function validarCadaCampo() {
            ...
            if ($('#cpf-produtor').val() === '' && $("#tipoPessoa option:selected").val() === 'R') {

                validadarDados('#validadorCPFPRODUTOR');
                $('#cpf-produtor').focus();
                validador = false;
            }

            if ($('#inscricao-produtor').val() === '' && $("#tipoPessoa option:selected").val() === 'R') {

                validadarDados('#validadorINSCRICAOPRODUTOR');
                $('#inscricao-produtor').focus();
                validador = false;
            }
