...
$route['visualizarObsItemPedido'] = 'venda/visualizarObsItemPedido';
$route['alterarObsItemPedido'] = 'venda/alterarObsItemPedido';
...
$route['listaPrecoGrupo/(:any)/(:any)'] = 'produto/listaPrecoGrupo';
