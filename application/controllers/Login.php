...
class Login extends MY_Controller {
    ...
    public function criaSession() {
        ...
        $sessaoUsuario = array(
            ...
            'VERIF_LIMITE_CREDITO' => $data['parametros']['VERIF_LIMITE_CREDITO'],
            'AVISO_EST_NEGATIVO' => $data['parametros']['AVISO_EST_NEGATIVO'],
            'REPETICAO_ITENS' => $data['parametros']['REPETICAO_ITENS'],
            'ONLINE_OBS_ITEM' => $data['parametros']['ONLINE_OBS_ITEM'],

            'PRECO_MINIMO_PEDIDO' => ($data['parametros']['PRECO_MINIMO_PEDIDO'] == 'N' || $data['parametros']['PRECO_MINIMO_PEDIDO'] == null) ? 'N' : 'S',
            'TABELA_PRECO_MINIMO_PEDIDO' => ($data['parametros']['TABELA_PRECO_MINIMO_PEDIDO'] == 'N' || $data['parametros']['TABELA_PRECO_MINIMO_PEDIDO'] == null) ? 'N' : $data['parametros']['TABELA_PRECO_MINIMO_PEDIDO']
        );
